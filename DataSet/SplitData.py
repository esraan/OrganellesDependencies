...
from FitModel.DModel import *
import os
import pandas as pd
from torch.utils.data import DataLoader


def split_data(images_dir="/storage/users/g-and-n/plates/metadata/",
               metadata_dir="/storage/users/g-and-n/plates/images/", plates=["24278", "24277"],
               target_dir="/sise/home/esraan/metadata_ctrl_trt/"):
